    ...
    for transcript_file in glob(join(args.base_dir, args.input_folder) + '/**/**/transcripts.txt'):
        ...
        if isfile(output_filepath):
            ...
            if len(content_output) == len(content_input):
                continue_convertion(output_filepath, complete_text_file, args.search_type, output_filepath, int(args.number_threads))

        execute_first_convertion(transcript_file, complete_text_file, args.search_type, output_filepath, int(args.number_threads))
